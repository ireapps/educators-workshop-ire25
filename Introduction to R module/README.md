...
2. first-r-notebook.Rmd (start here to practice working in notebooks)
3. analysis-in-tidyverse.Rmd (explains the main tidyverse functions we use for analysis)
4. bloomington-salaries-analysis.Rmd (practice tidyverse functions, create new columns)
5. tidyverse-joins.Rmd (learn how to join tables)
6. wnba-exercise-answers.Rmd (code to answer the practice questions at the bottom of tidyverse-joins.Rmd)
